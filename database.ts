...
const TEST_PRODUCTS = [
    { id: 2001, sku: 'TEST-PROD-001', asin: 'B0TEST001AA' },
    { id: 2002, sku: 'TEST-PROD-002', asin: 'B0TEST002BB' },
];

const TEST_KEYWORDS = [
    // Branded keywords (10)
    { id: 3001, text: 'test brand product', intent: 'BRANDED', stemmed: 'test brand product', matchType: 'EXACT' },
    { id: 3002, text: 'test brand item', intent: 'BRANDED', stemmed: 'test brand item', matchType: 'EXACT' },
    { id: 3003, text: 'official test product', intent: 'BRANDED', stemmed: 'official test product', matchType: 'PHRASE' },
    { id: 3004, text: 'test brand shop', intent: 'BRANDED', stemmed: 'test brand shop', matchType: 'PHRASE' },
    { id: 3005, text: 'test brand store', intent: 'BRANDED', stemmed: 'test brand store', matchType: 'BROAD' },
    { id: 3006, text: 'test brand quality', intent: 'BRANDED', stemmed: 'test brand quality', matchType: 'BROAD' },
    { id: 3007, text: 'test brand premium', intent: 'BRANDED', stemmed: 'test brand premium', matchType: 'EXACT' },
    { id: 3008, text: 'test brand original', intent: 'BRANDED', stemmed: 'test brand original', matchType: 'PHRASE' },
    { id: 3009, text: 'test brand authentic', intent: 'BRANDED', stemmed: 'test brand authentic', matchType: 'EXACT' },
    { id: 3010, text: 'test brand collection', intent: 'BRANDED', stemmed: 'test brand collection', matchType: 'BROAD' },
    
    // Generic keywords (25)
    { id: 3011, text: 'quality product', intent: 'GENERIC', stemmed: 'quality product', matchType: 'BROAD' },
    { id: 3012, text: 'best product online', intent: 'GENERIC', stemmed: 'best product online', matchType: 'BROAD' },
    { id: 3013, text: 'top rated product', intent: 'GENERIC', stemmed: 'top rated product', matchType: 'PHRASE' },
    { id: 3014, text: 'premium product', intent: 'GENERIC', stemmed: 'premium product', matchType: 'BROAD' },
    { id: 3015, text: 'affordable product', intent: 'GENERIC', stemmed: 'affordable product', matchType: 'BROAD' },
    { id: 3016, text: 'product for home', intent: 'GENERIC', stemmed: 'product home', matchType: 'PHRASE' },
    { id: 3017, text: 'product for office', intent: 'GENERIC', stemmed: 'product office', matchType: 'PHRASE' },
    { id: 3018, text: 'essential product', intent: 'GENERIC', stemmed: 'essential product', matchType: 'BROAD' },
    { id: 3019, text: 'must have product', intent: 'GENERIC', stemmed: 'must have product', matchType: 'PHRASE' },
    { id: 3020, text: 'everyday product', intent: 'GENERIC', stemmed: 'everyday product', matchType: 'BROAD' },
    { id: 3021, text: 'durable product', intent: 'GENERIC', stemmed: 'durable product', matchType: 'BROAD' },
    { id: 3022, text: 'long lasting product', intent: 'GENERIC', stemmed: 'long lasting product', matchType: 'PHRASE' },
    { id: 3023, text: 'reliable product', intent: 'GENERIC', stemmed: 'reliable product', matchType: 'BROAD' },
    { id: 3024, text: 'professional product', intent: 'GENERIC', stemmed: 'professional product', matchType: 'BROAD' },
    { id: 3025, text: 'commercial product', intent: 'GENERIC', stemmed: 'commercial product', matchType: 'PHRASE' },
    { id: 3026, text: 'industrial product', intent: 'GENERIC', stemmed: 'industrial product', matchType: 'BROAD' },
    { id: 3027, text: 'heavy duty product', intent: 'GENERIC', stemmed: 'heavy duty product', matchType: 'PHRASE' },
    { id: 3028, text: 'lightweight product', intent: 'GENERIC', stemmed: 'lightweight product', matchType: 'BROAD' },
    { id: 3029, text: 'portable product', intent: 'GENERIC', stemmed: 'portable product', matchType: 'BROAD' },
    { id: 3030, text: 'compact product', intent: 'GENERIC', stemmed: 'compact product', matchType: 'PHRASE' },
    { id: 3031, text: 'versatile product', intent: 'GENERIC', stemmed: 'versatile product', matchType: 'BROAD' },
    { id: 3032, text: 'multifunctional product', intent: 'GENERIC', stemmed: 'multifunctional product', matchType: 'PHRASE' },
    { id: 3033, text: 'innovative product', intent: 'GENERIC', stemmed: 'innovative product', matchType: 'BROAD' },
    { id: 3034, text: 'modern product', intent: 'GENERIC', stemmed: 'modern product', matchType: 'BROAD' },
    { id: 3035, text: 'advanced product', intent: 'GENERIC', stemmed: 'advanced product', matchType: 'PHRASE' },
    
    // Competitor keywords (15)
    { id: 3036, text: 'competitor brand a', intent: 'COMPETITOR', stemmed: 'competitor brand a', matchType: 'BROAD' },
    { id: 3037, text: 'competitor brand b', intent: 'COMPETITOR', stemmed: 'competitor brand b', matchType: 'BROAD' },
    { id: 3038, text: 'competitor brand c', intent: 'COMPETITOR', stemmed: 'competitor brand c', matchType: 'PHRASE' },
    { id: 3039, text: 'rival brand product', intent: 'COMPETITOR', stemmed: 'rival brand product', matchType: 'BROAD' },
    { id: 3040, text: 'alternative brand', intent: 'COMPETITOR', stemmed: 'alternative brand', matchType: 'BROAD' },
    { id: 3041, text: 'competitor product x', intent: 'COMPETITOR', stemmed: 'competitor product x', matchType: 'PHRASE' },
    { id: 3042, text: 'competitor product y', intent: 'COMPETITOR', stemmed: 'competitor product y', matchType: 'BROAD' },
    { id: 3043, text: 'competitor product z', intent: 'COMPETITOR', stemmed: 'competitor product z', matchType: 'PHRASE' },
    { id: 3044, text: 'leading competitor', intent: 'COMPETITOR', stemmed: 'leading competitor', matchType: 'BROAD' },
    { id: 3045, text: 'top competitor brand', intent: 'COMPETITOR', stemmed: 'top competitor brand', matchType: 'PHRASE' },
    { id: 3046, text: 'popular competitor', intent: 'COMPETITOR', stemmed: 'popular competitor', matchType: 'BROAD' },
    { id: 3047, text: 'competitor premium line', intent: 'COMPETITOR', stemmed: 'competitor premium line', matchType: 'PHRASE' },
    { id: 3048, text: 'competitor alternative', intent: 'COMPETITOR', stemmed: 'competitor alternative', matchType: 'BROAD' },
    { id: 3049, text: 'competitor similar product', intent: 'COMPETITOR', stemmed: 'competitor similar product', matchType: 'PHRASE' },
    { id: 3050, text: 'competitor equivalent', intent: 'COMPETITOR', stemmed: 'competitor equivalent', matchType: 'BROAD' },
];
